...
{
    public class OldEmitter:Container
    {
        // Statics #########################################################################
        ...
        // Variables #######################################################################
        // System
        protected Queue<VelocityParticle> _InactiveParticles = new Queue<VelocityParticle>();
        ...
        // CTOR ############################################################################
        public OldEmitter(Core core):base(core)
        {
        ...
        public virtual void DeactivateParticle(VelocityParticle particle)
        {
        ...
        public override void Update(Single deltaT)
        {
            ...
            if (IsTriggered && _SpawnTimer >= SpawnRate)
            {
                ...
                for (int i = 0; i < particleCount; i++)
                {
                    ...
                    else p = new VelocityParticle(this, _Core);
