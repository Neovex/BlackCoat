...
namespace BlackCoat.ParticleSystem
{
    ...
    public sealed class TextureEmitter : Emitter<TextureParticle, TexturedSpawnInfo>
    {
        /// <summary>
        ...
        public TextureEmitter(Core core, TexturedSpawnInfo info, BlendMode? blendMode = null, int depth = 0) :
